...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative min-h-screen  py-13 px-6 sm:px-8 lg:px-12 overflow-hidden"
    >
      {/* Animated Background */}
      <Image
        src="/back2.jpg"
        ...
        <div className="mb-16">
          <form onSubmit={handleSubmit} className="space-y-4 space-x-3 ">
            ...
            <button
              ...
              className={`group relative w-full px-8 py-5 rounded-xl font-bold text-lg transition-all duration-300 overflow-hidden ${
                isSubmitted
